...
* @notice This library is use to check the Chainlink oracle for stale data.
* If a price is stale, the funciton will revert, and render the DSCEngine unusable -  This is by design.
*  We want the DSCEngine to freeze if prices because stale.
 ...
 */
 ...
 library OracleLib {
    ...
    uint256 private constant TIMEOUT = 3 hours; // 3 * 60 * 60 = 10800seconds
